...
!function () {
    ...
    var d = function () {
        try {
            ...
            if (void 0 != navigator.mimeTypes["administration/x-shockwave-flash"]) {
                return !0
            }
        }
        return !1
    ...
    if (window.XMLHttpRequest && !window.FormData || window.FileAPI && FileAPI.forceLoad) {
        ...
        a("open", function (a) {
            ...
            return function (b, c) {
                if ("__setXHR_" === b) {
                    ...
                    this.__requestHeaders = this.__requestHeaders || {}, this.__requestHeaders[b] = c, a.apply(this, arguments)
                }
            }
        }), a("send", function (a) {
            return function () {
            ...
            if (window.FileAPI || (window.FileAPI = {}), FileAPI.forceLoad && (FileAPI.html5 = !1), !FileAPI.upload) {
                var a, b, c, e, f, g = document.createElement("script"), h = document.getElementsByTagName("script");
                if (window.FileAPI.jsUrl) {
                    a = window.FileAPI.jsUrl;
                } else {
                    if (window.FileAPI.jsPath) {
        ...
        }(), FileAPI.ngfFixIE = function (a, b, e, f) {
            if (!d()) {
                throw'Adode Flash Player need to be installed. To check ahead use "FileAPI.hasFlash"';
            }
            var g = function () {
                ...
                if (a.attr("disabled")) {
                    a.__ngf_elem__.removeClass("js-fileapi-wrapper");
                } else {
                    var i = a.__ngf_elem__;
                    i ? e(a.__ngf_elem__) : (i = a.__ngf_elem__ = b(), i.addClass("js-fileapi-wrapper"), !c(a), setTimeout(function () {
                        i.bind("mouseenter", g)
                    }, 10), i.bind("change", function (a) {
                        h.apply(this, [a]), f.apply(this, [a])
                    })), c(a) || i.css("position", "absolute").css("top", d(a[0]).top + "px").css("left", d(a[0]).left + "px").css("width", a[0].offsetWidth + "px").css("height", a[0].offsetHeight + "px").css("filter", "alpha(opacity=0)").css("display", a.css("display")).css("overflow", "hidden").css("z-index", "900000").css("visibility", "visible")
                }
            };
            a.bind("mouseenter", g);
            var h = function (a) {
