...
!function () {
    ...
    function c(a, b, c, g, h, i, j) {
        function k(a, b, c) {
            ...
            if (null != e) {
                for (var g = 0; g < e.length && d; g++) {
                    d = d && ("file" == e[g].kind || "" == e[g].kind) && f(a, h, b, e[g], c);
                }
            }
                    ...
                    if (b.isDirectory) {
                        ...
                        var g = function () {
                            e.readEntries(function (d) {
                                try {
                                    if (d.length) {
                                        f = f.concat(Array.prototype.slice.call(d || [], 0)), g();
                                    } else {
        ...
        if (c.dropAvailable && i(function () {
            ...
            return 1 == h(c.ngfHideOnDropNotAvailable)(a) && b.css("display", "none"), void 0;
        }
        {
    ...
    function g(a) {
        ...
        if (b.length > 1) {
            for (var d = 0; d < b.length; d++) {
                c += "(" + g(b[d]) + ")", d < b.length - 1 && (c += "|");
            }
        } else {
            0 == a.indexOf(".") && (a = "*" + a), c = "^" + a.replace(new RegExp("[.\\\\+*?\\[\\^\\]$(){}=!<>|:\\-]", "g"), "\\$&") + "$", c = c.replace(/\\\*/g, ".*").replace(/\\\?/g, ".");
        }
        return c
    }
    ...
    i.version = "4.2.0", i.service("Upload", ["$http", "$q", "$timeout", function (a, b, c) {
        function d(d) {
        ...
        this.upload = function (a) {
            return a.headers = a.headers || {}, a.headers["Content-Type"] = void 0, a.transformRequest = a.transformRequest ? angular.isArray(a.transformRequest) ? a.transformRequest : [a.transformRequest] : [], a.transformRequest.push(function (b) {
                ...
                for (h in a.fields) {
                    a.fields.hasOwnProperty(h) && (d[h] = a.fields[h]);
                }
                if (b && (d.data = b), a.formDataAppender) {
                    for (h in d) {
                        d.hasOwnProperty(h) && a.formDataAppender(c, h, d[h]);
                    }
                } else {
                    for (h in d) {
                        if (d.hasOwnProperty(h)) {
                            var e = d[h];
                            void 0 !== e && (angular.isDate(e) && (e = e.toISOString()), angular.isString(e) ? c.append(h, e) : a.sendObjectsAsJsonBlob && angular.isObject(e) ? c.append(h, new Blob([e], {type: "administration/json"})) : c.append(h, JSON.stringify(e)))
                        }
                    }
                }
                if (null != a.file) {
                    ...
                    if (angular.isArray(a.file)) {
                        for (var g = angular.isString(f), i = 0; i < a.file.length; i++) {
                            c.append(g ? f : f[i], a.file[i], a.fileName && a.fileName[i] || a.file[i].name);
                        }
                    } else {
    ...
    }]), i.directive("ngfSrc", ["$parse", "$timeout", "$parse", function (a, b, a) {
        return {
            restrict: "AE", link: function (c, d, e) {
                window.FileReader && c.$watch(e.ngfSrc, function (g) {
                    g && f(c, a, e, g, null) && (!window.FileAPI || -1 === navigator.userAgent.indexOf("MSIE 8") || g.size < 2e4) && (!window.FileAPI || -1 === navigator.userAgent.indexOf("MSIE 9") || g.size < 4e6) ? b(function () {
                        ...
                        a.readAsDataURL(g), a.onload = function (a) {
                            b(function () {
