...
!function (a) {
    ...
    function d(b) {
        ...
        return this instanceof d ? (this.file = b, this.size = b.size || 100, this.matrix = {
            sx: 0,
            sy: 0,
            sw: 0,
            sh: 0,
    ...
    function c(b, c, d) {
        ...
        if (f) {
            if (!e.toDataURL) {
                return a.readAsBinaryString(e, function (a) {
        ...
        append: function (a, b, c, d) {
            ...
            this._to([], b, function (a, b, d, e) {
                d.inc(), c(a, function (a, c) {
                    b.push("--_" + e + ('\r\nContent-Disposition: form-data; name="' + a.name + '"' + (a.file ? '; filename="' + g(a.file) + '"' : "") + (a.file ? "\r\nContent-Type: " + (a.type || "administration/octet-stream") : "") + "\r\n\r\n" + (a.file ? c : g(c)) + "\r\n")), d.next()
                }, !0)
            }, a.expando)
        }
    }, a.Form = f
        ...
        status: 0, statusText: "", constructor: e, getResponseHeader: function (a) {
            ...
            if (b.log("XHR._send:", e), c.cache || (k += (~k.indexOf("?") ? "&" : "?") + b.uid()), e.nodeName) {
                ...
                if (k = k.replace(/([a-z]+)=(\?)&?/i, ""), this.xhr && this.xhr.aborted) {
                    return b.log("Error: already aborted"), void 0;
                }
                if (g = h.xhr = b.getXHR(), e.params && (k += (k.indexOf("?") < 0 ? "?" : "&") + e.params.join("&")), g.open("POST", k, !0), b.withCredentials && (g.withCredentials = "true"), c.headers && c.headers["X-Requested-With"] || g.setRequestHeader("X-Requested-With", "XMLHttpRequest"), b.each(c.headers, function (a, b) {
                    ...
                    e.size && !r.size ? setTimeout(function () {
                        h.end(-1)
                    }) : (g.setRequestHeader("Content-Range", "bytes " + e.start + "-" + e.end + "/" + e.size), g.setRequestHeader("Content-Disposition", "attachment; filename=" + encodeURIComponent(e.name)), g.setRequestHeader("Content-Type", e.type || "administration/octet-stream"), g.send(r)), q = r = null
                } else {
                    if (g.upload && g.upload.addEventListener("progress", b.throttle(function (a) {
                            c.progress(a, h, c)
                        }, 100), !1), g.onreadystatechange = function () {
                            if (h.status = g.status, h.statusText = g.statusText, h.readyState = g.readyState, 4 == g.readyState) {
                                for (var a in f) {
    ...
    c.support.flash = function () {
        ...
        if (f.plugins && "object" == typeof f.plugins["Shockwave Flash"]) {
            d = f.plugins["Shockwave Flash"].description && !(b && b["administration/x-shockwave-flash"] && !b["administration/x-shockwave-flash"].enabledPlugin);
        } else {
            try {
        ...
        function h(a) {
            return ('<object id="#id#" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="' + (a.width || "100%") + '" height="' + (a.height || "100%") + '"><param name="movie" value="#src#" /><param name="flashvars" value="#flashvars#" /><param name="swliveconnect" value="true" /><param name="allowscriptaccess" value="always" /><param name="allownetworking" value="all" /><param name="menu" value="false" /><param name="wmode" value="#wmode#" /><embed flashvars="#flashvars#" swliveconnect="true" allownetworking="all" allowscriptaccess="always" name="#id#" src="#src#" width="' + (a.width || "100%") + '" height="' + (a.height || "100%") + '" menu="false" wmode="transparent" type="administration/x-shockwave-flash"></embed></object>').replace(/#(\w+)#/gi, function (b, c) {
                return a[c]
            })
        }
                    ...
                    do {
                        if (1 == a.nodeType) {
                            ...
                            return b.id = "_" + r, i(b, {
                                ...
                                position: "absolute",
                                zIndex: 1e6 + ""
                            }), a.parentNode.insertBefore(b, a), v.publish(b, r), void 0
                        }
                    ...
                    if (/input/i.test(b.nodeName) && "file" == b.type && !b.disabled) {
                        ...
                        if (c.multiFlash) {
                            ...
                            if ("p" != e) {
                                ...
                                if (!f) {
                                    return c.log("[err] FlashAPI.mouseover: js-fileapi-wrapper not found"), void 0;
                                }
                                i(g, {
                                    top: 0,
                                    left: 0,
