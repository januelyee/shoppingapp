 ...
 * @since 1.0
 */
public class SecurityDAOConstraintException extends RuntimeException {

    private static final long serialVersionUID = -1698680334212055626L;


    public SecurityDAOConstraintException(String msg) {
        super(msg);
    }


    public SecurityDAOConstraintException() {
        super();
    }


    public SecurityDAOConstraintException(String msg, Exception e) {
        super(msg, e);
    }
